        ...
        return <Validation.components.Form>
            <div className='row'>
                ...
                <div className='small-12 medium-6 columns'>
                    <label>
                        Firstname*
                        <Validation.components.Input errorClassName='is-invalid-input' containerClassName='' value='' name='firstname' validations={['required', 'alpha']}/>
                    </label>
                </div>
                <div className='small-12 medium-6 columns'>
                    <label>
                        Lastname*
                        <Validation.components.Input errorClassName='is-invalid-input' containerClassName='' value='' name='lastname' validations={['required', 'alpha']}/>
                    </label>
                </div>
            </div>
            <div className='row'>
                <div className='small-12 medium-6 columns'>
                    <label>
                        Email*
                        <Validation.components.Input errorClassName='is-invalid-input' containerClassName='' value='email@email.com' name='email' validations={['required', 'email']}/>
                    </label>
                </div>
                <div className='small-12 medium-6 columns'>
                    <label>
