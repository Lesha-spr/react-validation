...
describe('<Input/>', () => {
    ...
    describe('#render', () => {
        it('should render input as is with passed props/attributes', () => {
            const node = shallow(
                <Input type="checkbox" name="mock_name" value="mock_value" />,
                { context }
            );
        ...
        it('should be wrapped by div', () => {
            const node = shallow(
                <Input name="mock_name" value="mock_value" />,
                { context }
            );
    ...
    describe('initial state', () => {
        ...
        it('should be initially used if typed as radio or checkbox', () => {
            let node = shallow(
                <Input type="radio" name="mock_name" value="mock_value" />,
                { context }
            );
    ...
    describe('#change', () => {
        ...
        it('should toggle checked state', () => {
            ...
            const node = shallow(
                <Input type="checkbox" checked="checked" name="mock_name" value="value" />,
                { context }
            );
        ...
        it('should call onChange prop if passed', () => {
            ...
            const node = shallow(
                <Input onChange={onChange} name="mock_name" value="" />,
                { context }
            );
    ...
    describe('#blur', () => {
        ...
        it('should call onBlur prop if passed', () => {
            ...
            const node = shallow(
                <Input onBlur={onBlur} name="mock_name" value="" />,
                { context }
            );
