...
describe('<Select/>', () => {
    ...
    describe('#render', () => {
        it('should render without side effects', () => {
            const node = shallow(
                <Select name="mock_name" value="mock_value">
    ...
    describe('#change', () => {
        ...
        it('should call onChange prop if passed', () => {
            ...
            const node = shallow(
                <Select onChange={onChange} name="mock_name" value="">
                    <option value="">Choose</option>
                    <option value="mock_value">Value 1</option>
                    <option value="mock_other_value">Value 2</option>
                </Select>,
    ...
    describe('#blur', () => {
        ...
        it('should call onBlur prop if passed', () => {
            ...
            const node = shallow(
                <Select onBlur={onBlur} name="mock_name" value="">
                    <option value="">Choose</option>
                    <option value="mock_value">Value 1</option>
                    <option value="mock_other_value">Value 2</option>
                </Select>,
