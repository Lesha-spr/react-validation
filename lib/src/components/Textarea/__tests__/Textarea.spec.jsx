...
describe('<Textarea/>', () => {
    ...
    describe('#render', () => {
        it('should render Textarea as is with passed props/attributes', () => {
            const node = shallow(
                <Textarea name="mock_name" value="mock_value" />,
                { context }
            );
    ...
    describe('#change', () => {
        ...
        it('should call onChange prop if passed', () => {
            ...
            const node = shallow(
                <Textarea onChange={onChange} name="mock_name" value="" />,
                { context }
            );
    ...
    describe('#blur', () => {
        ...
        it('should call onBlur prop if passed', () => {
            ...
            const node = shallow(
                <Textarea onBlur={onBlur} name="mock_name" value="" />,
                { context }
            );
